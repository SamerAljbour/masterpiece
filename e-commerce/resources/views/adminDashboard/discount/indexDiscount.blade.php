              ...
              >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $discount->is_active ?"active" : "expired"  }}</td>
                        <td>
                            <div class="form-button-action">
                                <a href="{{ route('updateUser', $discount->id) }}" class="btn btn-link btn-primary btn-lg">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <form action="{{ route('deleteUser', $discount->id) }}" method="POST">
                                    @csrf
