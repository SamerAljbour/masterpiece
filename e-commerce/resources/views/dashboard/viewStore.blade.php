...
<div class="container">
    <div class="card overflow-hidden">
        <div class="card-body p-0">
            <img
    src="{{ $sellerInfo->store_thumbnail? Storage::url( $sellerInfo->store_thumbnail) : 'assets/img/blogpost.jpg' }}"
    alt="Store Thumbnail"
    class="img-fluid"
                    ...
                    <div class="col-md-6 col-lg-4 position-relative ">
                        <form action="{{ route('deleteProduct', $product->id) }}" method="POST" class="d-inline" onsubmit="return confirmDelete()">
                            ...
                            <div class="button-group d-flex">
                                ...
                                <button type="button" style="right:40px" data-bs-toggle="modal" data-bs-target="#modal-{{ $product->id }}" class="btn btn-info remove-button" title="View">
